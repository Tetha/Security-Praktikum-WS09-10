...
wir jeden Wert der Eingangsvariablen verschleiern und den
Wert der Ausgabevariablen mit einer symmetrischen Verschl\"usselung
und den Werten der Eingangsvariablen als Sch\"ussel in mehreren
Stufen verschl\"usseln.\\
Dadurch kann die Wahrheitstafel noch immer korrekt berechnet werden,
wenn die Eingaben der Berechnung durch die Verschleierung abgebildet
wurden (es kann ohne die Verschleierung zu kennen jedoch das Ergebnis
nicht genutzt werden). Es ist dem Auswerter zwar m\"oglich, eine andere
Ausgabe zu produzieren, indem er anhand der Eingangsvariablen einfach
eine andere Ausgabe dekodiert, allerdings ist die dann gew\"ahlte Ausgabe
rein zuf\"allig, wenn der Auswerter die Verschleierungsfunktionen nicht
kennt, da die verwendeten Werte der Verschleierung gleichverteilt sind.
\end{definition}
